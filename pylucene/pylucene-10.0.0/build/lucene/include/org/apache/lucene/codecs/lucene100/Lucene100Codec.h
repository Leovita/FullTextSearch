#ifndef org_apache_lucene_codecs_lucene100_Lucene100Codec_H
#define org_apache_lucene_codecs_lucene100_Lucene100Codec_H
    ...
    namespace lucene {
      namespace codecs {
        namespace lucene100 {
          ...
          class Lucene100Codec : public ::org::apache::lucene::codecs::Codec {
           public:
            enum {
              mid_init$_e7bdbe105ce1bafb,
              mid_init$_3958081b4c4bebb2,
            ...
            explicit Lucene100Codec(jobject obj) : ::org::apache::lucene::codecs::Codec(obj) {
              if (obj != NULL && mids$ == NULL)
                env->getClass(initializeClass);
            }
            Lucene100Codec(const Lucene100Codec& obj) : ::org::apache::lucene::codecs::Codec(obj) {}

            Lucene100Codec();
            Lucene100Codec(const ::org::apache::lucene::codecs::lucene100::Lucene100Codec$Mode &);
...
namespace org {
  namespace apache {
    namespace lucene {
      namespace codecs {
        namespace lucene100 {
          extern PyType_Def PY_TYPE_DEF(Lucene100Codec);
          extern PyTypeObject *PY_TYPE(Lucene100Codec);

          class t_Lucene100Codec {
          public:
            PyObject_HEAD
            Lucene100Codec object;
            static PyObject *wrap_Object(const Lucene100Codec&);
