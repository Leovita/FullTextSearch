#ifndef org_apache_lucene_backward_codecs_lucene99_Lucene99PostingsReader_H
#define org_apache_lucene_backward_codecs_lucene99_Lucene99PostingsReader_H
    ...
    namespace lucene {
      namespace backward_codecs {
        namespace lucene99 {
          ...
          class Lucene99PostingsReader : public ::org::apache::lucene::codecs::PostingsReaderBase {
           public:
            enum {
            ...
            explicit Lucene99PostingsReader(jobject obj) : ::org::apache::lucene::codecs::PostingsReaderBase(obj) {
              if (obj != NULL && mids$ == NULL)
                env->getClass(initializeClass);
            }
            Lucene99PostingsReader(const Lucene99PostingsReader& obj) : ::org::apache::lucene::codecs::PostingsReaderBase(obj) {}

            Lucene99PostingsReader(const ::org::apache::lucene::index::SegmentReadState &);
...
namespace org {
  namespace apache {
    namespace lucene {
      namespace backward_codecs {
        namespace lucene99 {
          extern PyType_Def PY_TYPE_DEF(Lucene99PostingsReader);
          extern PyTypeObject *PY_TYPE(Lucene99PostingsReader);

          class t_Lucene99PostingsReader {
          public:
            PyObject_HEAD
            Lucene99PostingsReader object;
            static PyObject *wrap_Object(const Lucene99PostingsReader&);
