#ifndef org_apache_lucene_backward_codecs_lucene912_Lucene912Codec_H
#define org_apache_lucene_backward_codecs_lucene912_Lucene912Codec_H
    ...
    namespace lucene {
      namespace backward_codecs {
        namespace lucene912 {
          ...
          class Lucene912Codec : public ::org::apache::lucene::codecs::Codec {
           public:
            enum {
              mid_init$_e7bdbe105ce1bafb,
              mid_init$_6b7265c0a4250f48,
            ...
            explicit Lucene912Codec(jobject obj) : ::org::apache::lucene::codecs::Codec(obj) {
              if (obj != NULL && mids$ == NULL)
                env->getClass(initializeClass);
            }
            Lucene912Codec(const Lucene912Codec& obj) : ::org::apache::lucene::codecs::Codec(obj) {}

            Lucene912Codec();
            Lucene912Codec(const ::org::apache::lucene::backward_codecs::lucene912::Lucene912Codec$Mode &);
...
namespace org {
  namespace apache {
    namespace lucene {
      namespace backward_codecs {
        namespace lucene912 {
          extern PyType_Def PY_TYPE_DEF(Lucene912Codec);
          extern PyTypeObject *PY_TYPE(Lucene912Codec);

          class t_Lucene912Codec {
          public:
            PyObject_HEAD
            Lucene912Codec object;
            static PyObject *wrap_Object(const Lucene912Codec&);
