      ...
      namespace util {
        ...
        class Constants : public ::java::lang::Object {
         public:
          ...
          static ::org::apache::lucene::store::ReadAdvice *DEFAULT_READADVICE;
          static jboolean FREE_BSD;
          static jboolean HAS_FAST_SCALAR_FMA;
          static jboolean HAS_FAST_VECTOR_FMA;
          static jboolean IS_CLIENT_VM;
          static jboolean IS_HOTSPOT_VM;
          static jboolean IS_JVMCI_VM;
