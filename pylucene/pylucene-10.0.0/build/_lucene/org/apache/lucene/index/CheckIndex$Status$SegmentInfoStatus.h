      ...
      namespace index {
        ...
        class CheckIndex$Status$SegmentInfoStatus : public ::java::lang::Object {
         public:
          ...
          ::org::apache::lucene::index::CheckIndex$Status$SoftDeletesStatus _get_softDeletesStatus() const;
          void _set_softDeletesStatus(const ::org::apache::lucene::index::CheckIndex$Status$SoftDeletesStatus &) const;
